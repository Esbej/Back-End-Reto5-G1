...
public class OrderService {
    ...
    public List<Order> findOrdersSalesManById(int id){
            return orderRepository.findOrdersSalesManById(id);
    }

    public List<Order> findOrdersSalesManByDate(Date date, int id) {
           return orderRepository.findOrdersSalesManByDate(date, id);
    }  
    public List<Order> findOrdersSalesManByState(String state, Integer id) {
            return orderRepository.findOrdersSalesManByState(state, id);
    }
}
